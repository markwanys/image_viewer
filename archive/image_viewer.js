...
function handleMouseWheel(e) {
    ...
    let translate_lu = math.matrix([[1, 0, -e.clientX], [0, 1, -e.clientY], [0, 0, 1]]);
    let mA = math.matrix([[scaleFactor, 0, 0], [0, scaleFactor, 0], [0, 0, 1]]);
    let translate_rd = math.matrix([[1, 0, e.clientX], [0, 1, e.clientY], [0, 0, 1]]);

    // Apply the transformation matrix
    let mC = math.multiply(math.multiply(translate_rd, mA),translate_lu)
